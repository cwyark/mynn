...
// IMGUI_DEMO_MARKER: mark interesting sections of the demo for code browsing. May be used to hook into an external tool, such as Dear ImGui Manual
#include "imgui_demo_marker_hooks.h"
#ifndef IMGUI_DEMO_MARKER
#define IMGUI_DEMO_MARKER(section)
#define IMGUI_DEMO_MARKER_SHOW_SHORT_INFO()
#endif
